"""
DXF preview for Streamlit.

Generates self-contained HTML with Three.js + dxf-parser inlined
from vendor files (no CDN needed).
"""
...
def generate_viewer_html(dxf_bytes: bytes, height: int = 500) -> str:
    """Generate self-contained HTML DXF viewer."""
...
<script>
const LC={{"POOL_OUTLINE":0x00ff88,"STAIRS":0x0088ff,"DIMENSIONS":0xff4444,"EQUIPMENT":0x888888,"COPING":0xff00ff,"SAFETY_LEDGE":0x00ffff,"LINER_SEAMS":0x00ff00,"POOL_STAIRS":0x00ff00,"POOL_DIMENSIONS":0xff4444,"POOL_TEXT":0x00ffff,"POOL_BENCH":0xffff00,"POOL_EQUIPMENT":0x888888,"GEOMETRY":0x00ff88,"TEXT":0x88ff00,"0":0xffffff}};
const b64="{dxf_b64}";
